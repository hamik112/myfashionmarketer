...
using Domain.Myfashion.Factory;
...
namespace Myfashionmarketer.Helper
{
    public static class SBUtils
    {
        ...
        public static Dictionary<Domain.Myfashion.Domain.TeamMemberProfile, object> GetUserProfilesccordingToGroup()
        {
            ...
            Dictionary<Domain.Myfashion.Domain.TeamMemberProfile, object> dict_TeamMember = new Dictionary<Domain.Myfashion.Domain.TeamMemberProfile, object>();
            ...
            List<Domain.Myfashion.Domain.TeamMemberProfile> lstTeamMemberProfiles = (List<Domain.Myfashion.Domain.TeamMemberProfile>)new JavaScriptSerializer().Deserialize(objApiTeamMemberProfile.GetTeamMemberProfilesByTeamId(Convert.ToString(team["Id"])), typeof(List<Domain.Myfashion.Domain.TeamMemberProfile>));

            //foreach (var item in TeamMemberProfiles)
            //{
            //    try
            //    {
            //        Domain.Myfashion.Domain.TeamMemberProfile objTeamMemberProfile = GetTeamMemberProfileFromJObject(item);
            ...
            foreach (Domain.Myfashion.Domain.TeamMemberProfile objTeamMemberProfile in lstTeamMemberProfiles)
            {
                try
                {
                    ISocialSiteAccount objISocialSiteAccount = GetSocialAccountFromTeamMemberProfile(objGroups.UserId, objTeamMemberProfile);
        ...
        [CustomException]
        private static ISocialSiteAccount GetSocialAccountFromTeamMemberProfile(Guid objUserid, Domain.Myfashion.Domain.TeamMemberProfile objTeamMemberProfile)
        {
        ...
        public static List<Domain.Myfashion.Domain.TeamMemberProfile> GetUserTeamMemberProfiles()
        {
            User objUser = (User)System.Web.HttpContext.Current.Session["User"];
            string groupid = System.Web.HttpContext.Current.Session["group"].ToString();

            List<Domain.Myfashion.Domain.TeamMemberProfile> lstTeamMemberProfile = new List<Domain.Myfashion.Domain.TeamMemberProfile>();
            ...
            objApiTeamMemberProfile.Timeout = 300000;
            //JArray TeamMemberProfiles = JArray.Parse(objApiTeamMemberProfile.GetTeamMemberProfilesByTeamId(Convert.ToString(team["Id"])));
            lstTeamMemberProfile = (List<Domain.Myfashion.Domain.TeamMemberProfile>)new JavaScriptSerializer().Deserialize(objApiTeamMemberProfile.GetTeamMemberProfilesByTeamId(Convert.ToString(team["Id"])), typeof(List<Domain.Myfashion.Domain.TeamMemberProfile>));
            //foreach (var item in TeamMemberProfiles)
            //{
            //    try
            //    {
        ...
        public static List<object> check(List<Domain.Myfashion.Domain.TeamMemberProfile> TeamMemberProfile)
        {

            return null;
        }

        //public static Dictionary<Domain.Myfashion.Domain.TeamMemberProfile, Dictionary<object, List<object>>> GetUserProfilesSnapsAccordingToGroup(List<Domain.Myfashion.Domain.TeamMemberProfile> TeamMemberProfile)
        //{
        //    User objUser = (User)System.Web.HttpContext.Current.Session["User"];
        //    Dictionary<Domain.Myfashion.Domain.TeamMemberProfile, Dictionary<object, List<object>>> dic_profilessnap = new Dictionary<Domain.Myfashion.Domain.TeamMemberProfile, Dictionary<object, List<object>>>();
        //    var dicprofilefeeds = new Dictionary<object, List<object>>();
        //    foreach (Domain.Myfashion.Domain.TeamMemberProfile item in TeamMemberProfile)
        //    {
        ...
        //}
        public static Dictionary<Domain.Myfashion.Domain.TeamMemberProfile, Dictionary<object, List<object>>> GetUserProfilesSnapsAccordingToGroup(List<Domain.Myfashion.Domain.TeamMemberProfile> TeamMemberProfile, int CountProfileSnapshot = 0)
        {
            User objUser = (User)System.Web.HttpContext.Current.Session["User"];
            Dictionary<Domain.Myfashion.Domain.TeamMemberProfile, Dictionary<object, List<object>>> dic_profilessnap = new Dictionary<Domain.Myfashion.Domain.TeamMemberProfile, Dictionary<object, List<object>>>();
            var dicprofilefeeds = new Dictionary<object, List<object>>();
            ...
            foreach (Domain.Myfashion.Domain.TeamMemberProfile item in TeamMemberProfile)
            {
                ...
                if (item.ProfileType == "gplus")
                {
                    try
                    {
                        ...
                        ApiobjGooglePlusAccount.Timeout = 300000; 
                        Domain.Myfashion.Domain.GooglePlusAccount _GooglePlusAccount = (GooglePlusAccount)new JavaScriptSerializer().Deserialize(ApiobjGooglePlusAccount.GetGooglePlusAccountDetailsById(objUser.Id.ToString(), item.ProfileId), typeof(GooglePlusAccount));
        ...
        public static Domain.Myfashion.Domain.Team GetTeamFromGroupId()
        {
            Api.Team.Team objApiTeam = new Api.Team.Team();
            objApiTeam.Timeout = 300000;
            string groupid = HttpContext.Current.Session["group"].ToString();
            Domain.Myfashion.Domain.Team team = (Domain.Myfashion.Domain.Team)new JavaScriptSerializer().Deserialize(objApiTeam.GetTeamByGroupId(HttpContext.Current.Session["group"].ToString()), typeof(Domain.Myfashion.Domain.Team));
            return team;
        }

        public static Dictionary<Domain.Myfashion.Domain.SocialProfile, object> GetAllUserProfiles()
        {
            User objUser = (User)System.Web.HttpContext.Current.Session["User"];
            Dictionary<Domain.Myfashion.Domain.SocialProfile, object> dict_TeamMember = new Dictionary<Domain.Myfashion.Domain.SocialProfile, object>();
            ...
            List<Domain.Myfashion.Domain.SocialProfile> lstSocialProfile = (List<Domain.Myfashion.Domain.SocialProfile>)new JavaScriptSerializer().Deserialize(ApiobjSocialProfile.GetAllSocialProfilesOfUser(objUser.Id.ToString()), typeof(List<Domain.Myfashion.Domain.SocialProfile>));
        ...
        public static Dictionary<Domain.Myfashion.Domain.GroupProfile, object> GetProfilesConnectedwithgroup()
        {
            User objUser = (User)System.Web.HttpContext.Current.Session["User"];
            Dictionary<Domain.Myfashion.Domain.GroupProfile, object> dict_TeamMember = new Dictionary<Domain.Myfashion.Domain.GroupProfile, object>();
            Api.GroupProfile.GroupProfile ApiobjGroupProfile = new Api.GroupProfile.GroupProfile();
            ApiobjGroupProfile.Timeout = 300000;
            List<Domain.Myfashion.Domain.GroupProfile> lstSocialProfile = (List<Domain.Myfashion.Domain.GroupProfile>)new JavaScriptSerializer().Deserialize(ApiobjGroupProfile.GetAllProfilesConnectedWithGroup(objUser.Id.ToString(), System.Web.HttpContext.Current.Session["selectedgroupid"].ToString()), typeof(List<Domain.Myfashion.Domain.GroupProfile>));
        ...
        public static Dictionary<string, string> GetTumblerData(string tumblrusername)
        {
            ...
            try
            {
                ...
                Domain.Myfashion.Domain.TumblerData objTumblerData = (Domain.Myfashion.Domain.TumblerData)(new JavaScriptSerializer().Deserialize(ApiobjTumblr.TumblerData(tumblrusername), typeof(Domain.Myfashion.Domain.TumblerData)));
