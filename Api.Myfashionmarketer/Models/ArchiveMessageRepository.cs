...
namespace Api.Myfashionmarketer.Models
{
    public class ArchiveMessageRepository
    {
        ...
        public List<Domain.Myfashion.Domain.ArchiveMessage> getAllArchiveMessage(Guid Userid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    List<Domain.Myfashion.Domain.ArchiveMessage> alstFBAccounts = session.CreateQuery("from ArchiveMessage where UserId = :userid order by CreatedDateTime desc")
                   .SetParameter("userid", Userid)
                   .List<Domain.Myfashion.Domain.ArchiveMessage>()
                   .ToList<Domain.Myfashion.Domain.ArchiveMessage>();
        ...
        public List<Domain.Myfashion.Domain.ArchiveMessage> getAllArchiveMessage(string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    //Proceed action to get Archive messages
                    // And return list of archive messages.
                    List<Domain.Myfashion.Domain.ArchiveMessage> alstFBAccounts = session.CreateQuery("from ArchiveMessage where ProfileId = :profileid order by CreatedDateTime desc")
        ...
        public Domain.Myfashion.Domain.ArchiveMessage getArchiveMessageDetails(Guid userid, string archiveId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        public List<Domain.Myfashion.Domain.ArchiveMessage> getAllArchiveMessageDetail(string profileid, Guid userid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.ArchiveMessage> alst = session.CreateQuery(str).SetParameter("userid", userid)
                       .List<Domain.Myfashion.Domain.ArchiveMessage>()
                       .ToList<Domain.Myfashion.Domain.ArchiveMessage>();
                        return alst;
