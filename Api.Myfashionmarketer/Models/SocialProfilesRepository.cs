...
namespace Api.Myfashionmarketer.Models
{
    public class SocialProfilesRepository : ISocialProfilesRepository
    {
        ...
        public List<Domain.Myfashion.Domain.SocialProfile> getAllSocialProfilesOfUser(Guid userid)
        {
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    List<Domain.Myfashion.Domain.SocialProfile> alst = session.CreateQuery("from SocialProfile where UserId = :userid and ProfileType!='googleplus'")
                    .SetParameter("userid", userid)
                    .List<Domain.Myfashion.Domain.SocialProfile>()
                    .ToList<Domain.Myfashion.Domain.SocialProfile>();
                    return alst;
        ...
        /// <returns>Return object of SocialProfile Class with  value of each member in the form of  list.(List<SocialProfile>)</returns>
        public List<Domain.Myfashion.Domain.SocialProfile> getAllSocialProfilesTypeOfUser(Guid userid, string profiletype)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    List<Domain.Myfashion.Domain.SocialProfile> alst = session.CreateQuery("from SocialProfile where UserId = :userid and ProfileType=:profiletype")
                    .SetParameter("userid", userid)
        ...
        /// </summary>
        /// <returns>Return object of SocialProfile Class with  value of each member in the form of  list.(List<SocialProfile>)</returns>
        public List<Domain.Myfashion.Domain.SocialProfile> getAllSocialProfiles()
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    List<Domain.Myfashion.Domain.SocialProfile> alst = session.CreateQuery("from SocialProfile").List<Domain.Myfashion.Domain.SocialProfile>().ToList<Domain.Myfashion.Domain.SocialProfile>();
        ...
        public void addNewProfileForUser(Domain.Myfashion.Domain.SocialProfile socio)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        public bool checkUserProfileExist(Domain.Myfashion.Domain.SocialProfile socio)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.SocialProfile> alst = session.CreateQuery("from SocialProfile where UserId = :userid and ProfileId = :profileid and  ProfileType = :profiletype")
                        .SetParameter("userid", socio.UserId)
                        .SetParameter("profileid", socio.ProfileId)
        ...
        /// <param name="socio">Set Values in a SocialProfile Class Property and Pass the Object of SocialProfile Class.(Domein.SocialProfile)</param>
        /// <returns>Return 1 for true and 0 for false.(int)</returns>
        public int updateSocialProfile(Domain.Myfashion.Domain.SocialProfile socio)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        /// <param name="profileid">Profile id.(String)</param>
        /// <returns>Return object of SocialProfile Class with  value of each member in the form of  list.(List<SocialProfile>)</returns>
        public List<Domain.Myfashion.Domain.SocialProfile> checkProfileExistsMoreThanOne(string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        List<Domain.Myfashion.Domain.SocialProfile> lstsocioprofile = session.CreateQuery("from SocialProfile where ProfileId = :profileid")
                        .SetParameter("profileid", profileid)
                        .List<Domain.Myfashion.Domain.SocialProfile>()
                        .ToList<Domain.Myfashion.Domain.SocialProfile>();
        ...
        public Domain.Myfashion.Domain.SocialProfile GetSocialProfileByProfileId(string SocialProfile)
        {
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        Domain.Myfashion.Domain.SocialProfile result = (Domain.Myfashion.Domain.SocialProfile)query.UniqueResult();
                        return result;
        ...
        public List<Domain.Myfashion.Domain.SocialProfile> GetSocialProfileByProfileType(string profiletype)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                {
                    //Proceed action, to get all data from table by user id and profile type.
                    List<Domain.Myfashion.Domain.SocialProfile> alst = session.CreateQuery("from SocialProfile where ProfileType=:profiletype")
                    .SetParameter("profiletype", profiletype)
                    .List<Domain.Myfashion.Domain.SocialProfile>()
                    .ToList<Domain.Myfashion.Domain.SocialProfile>();
