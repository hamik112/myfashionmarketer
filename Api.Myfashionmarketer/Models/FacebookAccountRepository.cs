...
namespace Api.Myfashionmarketer.Models
{
    public class FacebookAccountRepository : IFacebookAccountRepository
    {
        ...
        public void addFacebookUser(Domain.Myfashion.Domain.FacebookAccount fbaccount)
        {
        ...
        public void updateFacebookUserStatus(Domain.Myfashion.Domain.FacebookAccount fbaccount)
        {
        ...
        /// </summary>
        /// <param name="fbaccount">Set Values in a FacebookAccount Class Property and Pass the same Object of FacebookAccount Class.(Domain.FacebookAccount)</param>
        public void updateFacebookUser(Domain.Myfashion.Domain.FacebookAccount fbaccount)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        //    }//End session
        //}
        public List<Domain.Myfashion.Domain.FacebookAccount> getAllFacebookAccountsOfUser(Guid UserId)
        {
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    query.SetParameter("userid", UserId);
                    //ArrayList alstFBAccounts = new ArrayList();
                    List<Domain.Myfashion.Domain.FacebookAccount> alstFBAccounts = new List<Domain.Myfashion.Domain.FacebookAccount>();

                    foreach (var item in query.Enumerable())
                    {
                        alstFBAccounts.Add((Domain.Myfashion.Domain.FacebookAccount)item);
                    }
                    return alstFBAccounts;
                }//End Transaction
            }//End session
        ...
        public Domain.Myfashion.Domain.FacebookAccount getFacebookAccountDetailsById(string Fbuserid, Guid userId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    query.SetParameter("userId", userId);
                    Domain.Myfashion.Domain.FacebookAccount result = (Domain.Myfashion.Domain.FacebookAccount)query.UniqueResult();
                    return result;
                }//End Transaction
            }//End session
        }
        ...
        public Domain.Myfashion.Domain.FacebookAccount getFacebookAccountDetailsById(string Fbuserid)
        {

            Domain.Myfashion.Domain.FacebookAccount result = new Domain.Myfashion.Domain.FacebookAccount();
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                //After Session creation, start Transaction.
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    // proceed action, to get all Facebook Account of User by UserId(Guid) and FbUserId(string).
                    List<Domain.Myfashion.Domain.FacebookAccount> objlstfb = session.CreateQuery("from FacebookAccount where FbUserId = :Fbuserid ")
                            .SetParameter("Fbuserid", Fbuserid)
                       .List<Domain.Myfashion.Domain.FacebookAccount>().ToList<Domain.Myfashion.Domain.FacebookAccount>();
                    if (objlstfb.Count > 0)
                    {
                        result = objlstfb[0];
                    }
        ...
        public List<Domain.Myfashion.Domain.FacebookAccount> getAllAccountDetail(string profileid,Guid userid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.FacebookAccount> alst = session.CreateQuery(str).SetParameter("userid",userid)
                       .List<Domain.Myfashion.Domain.FacebookAccount>()
                       .ToList<Domain.Myfashion.Domain.FacebookAccount>();
                        return alst;
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        // And Set the reuired paremeters to find the specific values.
                       // List<Domain.Myfashion.Domain.FacebookAccount> alst = session.CreateQuery("from FacebookAccount where UserId = :userid and FbUserId = :fbuserid")
                       // .SetParameter("userid", Userid)
                       // .SetParameter("fbuserid", FbUserId)
                       // .List<Domain.Myfashion.Domain.FacebookAccount>()
                       //.ToList<Domain.Myfashion.Domain.FacebookAccount>();
                       ...
                       // else
                       //     return true;
                        bool exist = session.Query<Domain.Myfashion.Domain.FacebookAccount>()
        ...
        public List<Domain.Myfashion.Domain.FacebookAccount> GetAllFacebookAccountByUserId(Guid UserId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.FacebookAccount> alst = session.CreateQuery("from FacebookAccount where UserId = :userid")
                       .SetParameter("userid", UserId)
                       .List<Domain.Myfashion.Domain.FacebookAccount>()
                       .ToList<Domain.Myfashion.Domain.FacebookAccount>();
                        return alst;
        ...
        public Domain.Myfashion.Domain.FacebookAccount getToken()
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        //Proceed action, to get all read feed messages by user id and profile id. 
                        //Order by EntryDate DESC
                        List<Domain.Myfashion.Domain.FacebookAccount> alst = session.CreateQuery("from FacebookAccount where AccessToken!=''")                    
                       .List<Domain.Myfashion.Domain.FacebookAccount>()
                       .ToList<Domain.Myfashion.Domain.FacebookAccount>();
        ...
        public List<Domain.Myfashion.Domain.FacebookAccount> getFbAccounts()
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        List<Domain.Myfashion.Domain.FacebookAccount> alst = session.Query<Domain.Myfashion.Domain.FacebookAccount>().Where(x => x.IsActive == 1 && x.AccessToken!="").Take(20).ToList();
                        return alst;
                    }
                    catch (Exception ex)
                    {
                        return new List<Domain.Myfashion.Domain.FacebookAccount>();
                    }
                }
            }
        }
