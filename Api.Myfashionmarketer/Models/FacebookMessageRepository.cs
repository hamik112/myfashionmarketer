...
namespace Api.Myfashionmarketer.Models
{
    public class FacebookMessageRepository : IFacebookMessageRepository
    {
        ...
        public void addFacebookMessage(Domain.Myfashion.Domain.FacebookMessage fbmsg)
        {
        ...
        public int deleteFacebookMessage(Domain.Myfashion.Domain.FacebookMessage fbaccount)
        {
            throw new NotImplementedException();
        }

        public void updateFacebookMessage(Domain.Myfashion.Domain.FacebookMessage fbmessage)
        {
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                //After Session creation, start Transaction.
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllFacebookMessagesOfUser(Guid UserId, string profileId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.FacebookMessage> alst = session.CreateQuery("from FacebookMessage where UserId = :userid and ProfileId = :profileId")
                         .SetParameter("userid", UserId)
                         .SetParameter("profileId", profileId)
                         .List<Domain.Myfashion.Domain.FacebookMessage>()
                         .ToList<Domain.Myfashion.Domain.FacebookMessage>();
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> getFacebookUserWallPost(Guid userid, string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.FacebookMessage> alst = session.CreateQuery("from FacebookMessage where UserId = :userid and ProfileId = :profileId and Type='fb_home'")
                         .SetParameter("userid", userid)
                         .SetParameter("profileId", profileid)
                         .List<Domain.Myfashion.Domain.FacebookMessage>()
                         .ToList<Domain.Myfashion.Domain.FacebookMessage>();
        ...
        public Domain.Myfashion.Domain.FacebookMessage GetFacebookUserWallPostDetails(Guid msgid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        //Proceed action to, get all wall post of Facebook User.
                        List<Domain.Myfashion.Domain.FacebookMessage> alst = session.CreateQuery("from FacebookMessage where Id = :msgid")
        ...
        /// <returns>Return a object of FacebookMessage Class with  value of each member in form List type.</returns>
        public List<Domain.Myfashion.Domain.FacebookMessage> getFacebookUserWallPost(Guid userid, string profileid, int count)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllMessageOfProfile(string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.FacebookMessage> alst = session.CreateQuery("from FacebookMessage where ProfileId = :profileId order by MessageDate desc")
                        .SetParameter("profileId", profileid)
                        .List<Domain.Myfashion.Domain.FacebookMessage>()
                        .ToList<Domain.Myfashion.Domain.FacebookMessage>();
        ...
        /// <param name="profileid">profileId FacebookMessage(String)</param>
        /// <returns>Return all Message on behalf of ProfileId in form List type.</returns>
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllMessageOfProfileWithRange(string profileid, string noOfDataToSkip)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllWallpostsOfProfile(string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.FacebookMessage> alst = session.CreateQuery("from FacebookMessage where ProfileId = :profileId and Type='fb_home'")
                        .SetParameter("profileId", profileid)
                        .List<Domain.Myfashion.Domain.FacebookMessage>()
                        .ToList<Domain.Myfashion.Domain.FacebookMessage>();
        ...
        /// <param name="count">Count is used for counting upto 10 results.</param>
        /// <returns>Return all Message on behalf of ProfileId in form List type.</returns>
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllWallpostsOfProfile(string profileid, int count)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    {
                        //Proceed action to get all Wallpost of User from FacebookMessage.
                        List<Domain.Myfashion.Domain.FacebookMessage> lst = session.CreateQuery("from FacebookMessage where ProfileId = :profileId and Type='fb_home' order by MessageDate Desc")
                        .SetParameter("profileId", profileid)
                        .SetFirstResult(count)
                        .SetMaxResults(10)
                        .List<Domain.Myfashion.Domain.FacebookMessage>()
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        bool exist = session.Query<Domain.Myfashion.Domain.FacebookMessage>()
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllInboxMessages(string profileid)
        {
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.FacebookMessage> lstfbmsg = session.CreateQuery("from FacebookMessage where Type = 'inbox_message' and ProfileId = :profid")
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllSentMessages(string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.FacebookMessage> lstfbmsg = session.CreateQuery("from FacebookMessage where ProfileId = :profid ORDER BY MessageDate DESC")
                        .SetParameter("profid", profileid)
                        .List<Domain.Myfashion.Domain.FacebookMessage>()
                        .ToList<Domain.Myfashion.Domain.FacebookMessage>();
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllMessageDetail(string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        str += ")";
                        List<Domain.Myfashion.Domain.FacebookMessage> alst = session.CreateQuery(str)
                       .List<Domain.Myfashion.Domain.FacebookMessage>()
                       .ToList<Domain.Myfashion.Domain.FacebookMessage>();
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllMessageDetail(string profileid, string noOfDataToSkip)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        /// <param name="count">Count is used for counting upto 10 results.</param>
        /// <returns>Return all Message on behalf of ProfileId in form List type.</returns>
        public List<Domain.Myfashion.Domain.FacebookMessage> GetAllWallpostsOfProfileAccordingtoGroup(string profileid, int count, Guid UserId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        List<Domain.Myfashion.Domain.FacebookMessage> lstFacebookMessage = new List<Domain.Myfashion.Domain.FacebookMessage>();
                        ...
                        foreach (var item in lst)
                        {
                            try
                            {
                                Domain.Myfashion.Domain.FacebookMessage fbmsg = new Domain.Myfashion.Domain.FacebookMessage();
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        // List<Domain.Myfashion.Domain.FacebookMessage> alst = session.CreateQuery(str).SetParameter("userid", userid).SetParameter("AssinDate", AssinDate).SetParameter("msgtype", msgtype)
                        //.List<Domain.Myfashion.Domain.FacebookMessage>()
                        //.ToList<Domain.Myfashion.Domain.FacebookMessage>();
                        // return alst;
                        int alst = session.Query<Domain.Myfashion.Domain.FacebookMessage>().Where(x => x.UserId.Equals(userid) && arrsrt.Contains(x.ProfileId) && x.MessageDate.Date >= AssinDate.Date).Count();
                        return alst;
                    }
                    catch (Exception ex)
                    {
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllFacebookTagOfUsers(Guid UserId, string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        List<Domain.Myfashion.Domain.FacebookMessage> lstmsg = session.CreateQuery("from FacebookMessage where UserId = :UserId and ProfileId = :profileid and Type ='fb_tag'")
                        .SetParameter("UserId", UserId)
                        .SetParameter("profileid", profileid)
                            // .SetMaxResults(10)
                        .List<Domain.Myfashion.Domain.FacebookMessage>()
        ...
        /// <param name="profileid">Profile id.(String)</param>
        /// <returns>Return object of FacebookTag Class with  value of each member in the form of list.(List<FacebookMessage>)</returns>
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllFacebookstatusOfUsers(Guid UserId, string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        List<Domain.Myfashion.Domain.FacebookMessage> lstmsg = session.CreateQuery("from FacebookMessage where UserId = :UserId and ProfileId = :profileid and Type ='fb_home' and ProfileId = FromId")
                        .SetParameter("UserId", UserId)
                        .SetParameter("profileid", profileid)
                            // .SetMaxResults(10)
                        .List<Domain.Myfashion.Domain.FacebookMessage>()
        ...
        /// <param name="profileid">Profile id.(String)</param>
        /// <returns>Return object of FacebookTag Class with  value of each member in the form of list.(List<FacebookMessage>)</returns>
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllFacebookUserFeedOfUsers(Guid UserId, string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        public Domain.Myfashion.Domain.FacebookMessage GetMessageDetailByMessageid(string msgid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        Domain.Myfashion.Domain.FacebookMessage result = (Domain.Myfashion.Domain.FacebookMessage)query.UniqueResult();
                        return result;
                    }
                    catch (Exception ex)
                    {
        ...
        public Domain.Myfashion.Domain.FacebookMessage GetFacebookMessageByMessageId(Guid userid, string MessageId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        query.SetParameter("userid", userid);
                        var result = query.UniqueResult();
                        return (Domain.Myfashion.Domain.FacebookMessage)result;
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine(ex.StackTrace);
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> GetAllFacebookMessageForArchive(string profileid, Guid userid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.FacebookMessage> alst = session.CreateQuery(str).SetParameter("userid", userid)
                        .List<Domain.Myfashion.Domain.FacebookMessage>()
                        .ToList<Domain.Myfashion.Domain.FacebookMessage>();
                        return alst;
                    }
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllFacebookMessagesOfSBUserWithRange(string UserId, string noOfDataToSkip)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.FacebookMessage> alst = session.CreateQuery("from FacebookMessage where  UserId = :UserId order by MessageDate desc")
                        .SetParameter("UserId", UserId)
                          .SetFirstResult(Convert.ToInt32(noOfDataToSkip))
                        .SetMaxResults(20)
                        .List<Domain.Myfashion.Domain.FacebookMessage>()
        ...
        /// <param name="count">Count is used for counting upto 10 results.</param>
        /// <returns>Return all Message on behalf of ProfileId in form List type.</returns>
        public List<Domain.Myfashion.Domain.FacebookMessage> GetAllWallpostsOfProfileAccordingtoGroupByUserIdAndProfileId1WithRange(string UserId, string keyword, string ProfileId, string count)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    {
                        //Proceed action to get all Wallpost of User from FacebookMessage.
                        //List<Domain.Myfashion.Domain.FacebookMessage> lst = session.CreateQuery("from FacebookMessage where ProfileId = :profileId and UserId=:userid and Type='fb_home' order by MessageDate Desc")
                        //.SetParameter("profileId", ProfileId)
                        //.SetParameter("userid", UserId)
                        //.SetFirstResult(count)
                        //.SetMaxResults(10)
        ...
        /// <param name="profileid">Profile id.(String)</param>
        /// <returns>Return object of FacebookTag Class with  value of each member in the form of list.(List<FacebookMessage>)</returns>
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllFacebookUserFeedOfUsersByUserIdAndProfileId1WithRange(string UserId, string keyword, string ProfileId, string count)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllMessageOfProfileWithRange(string profileid, string noOfDataToSkip, Guid UserId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.FacebookMessage> lstmsg = session.Query<Domain.Myfashion.Domain.FacebookMessage>().Where(u => u.UserId == UserId && u.ProfileId.Equals(profileid) && u.IsArchived != 1).OrderByDescending(x => x.MessageDate).Skip(Convert.ToInt32(noOfDataToSkip)).Take(15).ToList<Domain.Myfashion.Domain.FacebookMessage>();
                        ...
                        //.SetMaxResults(15)
                        //.List<Domain.Myfashion.Domain.FacebookMessage>()
                        //.ToList<Domain.Myfashion.Domain.FacebookMessage>().Where(u => u.UserId==UserId).ToList();
        ...
        public List<Domain.Myfashion.Domain.FacebookMessage> getAllMessageDetail(string profileid, string noOfDataToSkip, Guid UserId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    {
                        string[] arrsrt = profileid.Split(',');
                        List<Domain.Myfashion.Domain.FacebookMessage> lstmsg = session.Query<Domain.Myfashion.Domain.FacebookMessage>().Where(u => u.UserId == UserId && arrsrt.Contains(u.ProfileId) && u.IsArchived != 1).OrderByDescending(x => x.MessageDate).Skip(Convert.ToInt32(noOfDataToSkip)).Take(15).ToList<Domain.Myfashion.Domain.FacebookMessage>();
                        ...
                        // .SetMaxResults(15)
                        //.List<Domain.Myfashion.Domain.FacebookMessage>()
                        //.ToList<Domain.Myfashion.Domain.FacebookMessage>().OrderByDescending(x => x.MessageDate)
                        //.Where(u=>u.UserId==UserId).ToList<Domain.Myfashion.Domain.FacebookMessage>();
                        // alst = alst.GroupBy(m => m.MessageId).Select(a => a.First()).ToList();
