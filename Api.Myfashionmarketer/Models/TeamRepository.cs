...
namespace Api.Myfashionmarketer.Services
{
    public class TeamRepository 
    {
        ...
        public void addNewTeam(Domain.Myfashion.Domain.Team team)
        {
        ...
        public int deleteTeam(Domain.Myfashion.Domain.Team team)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        ///// </summary>
        ///// <param name="team">Set Values in a Team Class Property and Pass the Object of Team Class.(Domein.Team)</param>
        //public void updateTeam(Domain.Myfashion.Domain.Team team)
        //{
        //    //Creates a database connection and opens up a session
        //    using (NHibernate.ISession session = SessionFactory.GetNewSession())
        //    {
        ...
        public List<Domain.Myfashion.Domain.Team> getAllTeamsOfUser(Guid UserId, Guid groupid, string EmailId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.Team> alstFBAccounts = session.CreateQuery("from Team where GroupId=:groupid and InviteStatus =1")//session.CreateQuery("from Team where GroupId=:groupid and InviteStatus =1 and EmailId!=:EmailId")
                        .SetParameter("groupid", groupid)
                            //.SetParameter("EmailId", EmailId)
                        .List<Domain.Myfashion.Domain.Team>()
                        .ToList<Domain.Myfashion.Domain.Team>();
        ...
        public Domain.Myfashion.Domain.Team getTeam(string EmailId, Guid UserId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        Domain.Myfashion.Domain.Team alstFBAccounts = query.UniqueResult<Domain.Myfashion.Domain.Team>();
        ...
        /// <param name="UserId">User id.(Guid)</param>
        /// <returns>Return the object of Team class with value.(Domain.Team)</returns>
        public Domain.Myfashion.Domain.Team getMemberById(Guid memberId, Guid UserId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        /// <returns>Return the object of Team class with value.(Domain.Team)</returns>
        public Domain.Myfashion.Domain.Team getMemberByEmailId(Guid UserId, string EmailId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        var alstFBAccounts = query.UniqueResult<Domain.Myfashion.Domain.Team>();
        ...
        /// <returns>Return the object of Team class with value.(Domain.Team)</returns>
        public Domain.Myfashion.Domain.Team getTeamByEmailId(string EmailId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        /// <returns>Return the object of Team class with value.(Domain.Team)</returns>
        public Domain.Myfashion.Domain.Team getTeamById(Guid Id)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        public Domain.Myfashion.Domain.Team getAllGroupsDetails(string emailId, Guid groupId, Guid userid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.Team> lstDetails = session.CreateQuery("from Team where (EmailId=:emailId or UserId=:userid) and GroupId=:groupId")
                       .SetParameter("emailId", emailId)
                        .SetParameter("groupId", groupId)
                         .SetParameter("userid", userid)
                       .List<Domain.Myfashion.Domain.Team>()
        ...
        public Domain.Myfashion.Domain.Team getAllDetails(Guid groupid, string useremail)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.Team> lstDetails = session.CreateQuery("from Team where GroupId=:groupid and EmailId=:useremail")
        ...
        public List<Domain.Myfashion.Domain.Team> getAllDetailsUserEmail(Guid groupId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.Team> alstFBAccounts = session.CreateQuery("from Team where GroupId=:groupId")
                        .SetParameter("groupId", groupId)
                        .List<Domain.Myfashion.Domain.Team>()
                        .ToList<Domain.Myfashion.Domain.Team>();
        ...
        public Domain.Myfashion.Domain.Team GetTeamByGroupId(Guid groupId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.Team> alstFBAccounts = session.CreateQuery("from Team where GroupId=:groupId order by StatusUpdateDate")
                        .SetParameter("groupId", groupId)
                        .List<Domain.Myfashion.Domain.Team>()
                        .ToList<Domain.Myfashion.Domain.Team>();
        ...
        public Domain.Myfashion.Domain.Team getAllDetailsByTeamID(Guid Id, Guid groupId)
        {
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.Team> alstAccounts = session.CreateQuery("from Team where Id=:id and GroupId=:groupId")
                        .SetParameter("id", Id)
                        .SetParameter("groupId", groupId)
                        .List<Domain.Myfashion.Domain.Team>()
                        .ToList<Domain.Myfashion.Domain.Team>();
        ...
        public List<Domain.Myfashion.Domain.Team> GetAllTeamExcludeUser(Guid groupId, Guid userid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.Team> alstFBAccounts = session.CreateQuery("from Team where GroupId=:groupId and UserId!=:uid")
                        .SetParameter("groupId", groupId)
        ...
        public Domain.Myfashion.Domain.Team GetAllTeam(Guid groupId, Guid userid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        public List<Domain.Myfashion.Domain.Team> GetAllTeamExcludeUserAccordingtoStatus(Guid groupId, Guid userid, int status)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        List<Domain.Myfashion.Domain.Team> alstFBAccounts = session.CreateQuery("from Team where GroupId=:groupId and UserId=:uid and InviteStatus=:status")
                        .SetParameter("groupId", groupId)
                        .SetParameter("uid", userid)
        ...
        public List<Domain.Myfashion.Domain.Team> GetAllTeamOfUserEmail(string emailid, Guid groupid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        List<Domain.Myfashion.Domain.Team> alstFBAccounts = session.CreateQuery("from Team where EmailId=:email and GroupId!=:gid and InviteStatus=:status")
        ...
        /// <param name="EmailId">memver Email id.(String)</param>
        /// <returns>Return the object of Team class with value.(Domain.Team)</returns>
        public List<Domain.Myfashion.Domain.Team> GetTeamByUserid(Guid userid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    {
                        //Proceed action, to get team details.
                        List<Domain.Myfashion.Domain.Team> alstFBAccounts = session.CreateQuery("from Team where UserId =:uid and InviteStatus =1")
                       .SetParameter("uid", userid)
                        .List<Domain.Myfashion.Domain.Team>()
                        .ToList<Domain.Myfashion.Domain.Team>();
                        return alstFBAccounts;
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public List<Domain.Myfashion.Domain.Team> GetTeamByTeamId(Guid TeamId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    {
                        //Proceed action, to get team details.
                        List<Domain.Myfashion.Domain.Team> alstteam = session.CreateQuery("from Team where Id =:TeamId")
                       .SetParameter("TeamId", TeamId)
                        .List<Domain.Myfashion.Domain.Team>()
                        .ToList<Domain.Myfashion.Domain.Team>();
                        return alstteam;
