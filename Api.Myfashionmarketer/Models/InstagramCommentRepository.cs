...
namespace Api.Myfashionmarketer.Models
{
    public class InstagramCommentRepository : IInstagramComment
    {
        ...
        public void addInstagramComment(Domain.Myfashion.Domain.InstagramComment inscomment)
        {
        ...
        public int deleteInstagramComment(Domain.Myfashion.Domain.InstagramComment inscomment)
        {
            throw new NotImplementedException();
        }

        public int updateInstagramComment(Domain.Myfashion.Domain.InstagramComment inscomment)
        {
            throw new NotImplementedException();
        }
        ...
        public List<Domain.Myfashion.Domain.InstagramComment> getAllInstagramCommentsOfUser(Guid UserId, string feedid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.InstagramComment> alst = session.CreateQuery("from InstagramComment where UserId = :userid and FeedId=:feedid Order By CommentDate DESC")
                        .SetParameter("userid", UserId)
                        .SetParameter("feedid", feedid)
                        .List<Domain.Myfashion.Domain.InstagramComment>()
                        .ToList<Domain.Myfashion.Domain.InstagramComment>();
                        #region Oldcode
