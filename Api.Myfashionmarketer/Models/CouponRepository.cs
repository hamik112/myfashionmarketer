...
namespace Api.Myfashionmarketer.Models
{
    public class CouponRepository
    {
        ...
        public string Add(Domain.Myfashion.Domain.Coupon coupon)
        {
            string res = null;
            try
            {
        ...
        public List<Domain.Myfashion.Domain.Coupon> GetCouponByCouponCode(Domain.Myfashion.Domain.Coupon coupon)
        {
            List<Domain.Myfashion.Domain.Coupon> res = new List<Domain.Myfashion.Domain.Coupon>();
            try
            {
                //Creates a database connection and opens up a session
                using (NHibernate.ISession session = SessionFactory.GetNewSession())
                {
                    ...
                    using (NHibernate.ITransaction transaction = session.BeginTransaction())
                    {
                        ...
                        .List<Domain.Myfashion.Domain.Coupon>().ToList<Domain.Myfashion.Domain.Coupon>();
                    }//End transaction
                }//End session
            }
            catch (Exception ex)
        ...
        public List<Domain.Myfashion.Domain.Coupon> GetCouponByCouponId(Domain.Myfashion.Domain.Coupon coupon)
        {
            //Coupon res = null;
            List<Domain.Myfashion.Domain.Coupon> res = new List<Domain.Myfashion.Domain.Coupon>();
            try
        ...
        public List<Domain.Myfashion.Domain.Coupon> GetAllCoupon()
        {
            ...
            try
            {
                ...
                using (NHibernate.ISession session = SessionFactory.GetNewSession())
                {
                    ...
                    using (NHibernate.ITransaction transaction = session.BeginTransaction())
                    {
                        ...
                        res = session.CreateQuery("from Coupon").List<Domain.Myfashion.Domain.Coupon>().ToList<Domain.Myfashion.Domain.Coupon>();
        ...
        //public int SetCouponById(Domain.Myfashion.Domain.Coupon coupon)
        //{
        //    int res = 0;
