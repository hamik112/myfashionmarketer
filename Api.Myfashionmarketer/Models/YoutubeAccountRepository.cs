...
namespace Api.Myfashionmarketer.Models
{
    ...
    {
        public static void Add(Domain.Myfashion.Domain.YoutubeAccount YoutubeAccount)
        {
        ...
        public bool checkYoutubeUserExists(Domain.Myfashion.Domain.YoutubeAccount YoutubeAccount)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        public bool checkTubmlrUserExists(Domain.Myfashion.Domain.YoutubeAccount objTumblrAccount)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        public Domain.Myfashion.Domain.YoutubeAccount getYoutubeAccountDetailsById(string youtubeId)
        {

            Domain.Myfashion.Domain.YoutubeAccount result = new Domain.Myfashion.Domain.YoutubeAccount();
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                //After Session creation, start Transaction.
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    List<Domain.Myfashion.Domain.YoutubeAccount> objlstfb = session.CreateQuery("from YoutubeAccount where YtUserId = :Fbuserid ")
                            .SetParameter("Fbuserid", youtubeId)
                       .List<Domain.Myfashion.Domain.YoutubeAccount>().ToList<Domain.Myfashion.Domain.YoutubeAccount>();
                    if (objlstfb.Count > 0)
                    {
                        result = objlstfb[0];
                    }
        ...
        public Domain.Myfashion.Domain.YoutubeAccount getYoutubeAccountDetailsById(string youtubeId,Guid userid)
        {
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    // proceed action, to get all Facebook Account of User by UserId(Guid) and FbUserId(string).
                    List<Domain.Myfashion.Domain.YoutubeAccount> objlstfb = session.CreateQuery("from YoutubeAccount where YtUserId = :Fbuserid and UserId=:userid")
                            .SetParameter("Fbuserid", youtubeId)
        ...
        public List<Domain.Myfashion.Domain.YoutubeAccount> getYoutubeAccountDetailsById(Guid userId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.YoutubeAccount> lstmsg = session.CreateQuery("from YoutubeAccount where UserId=:userId")
                        .SetParameter("userId", userId)
                        .List<Domain.Myfashion.Domain.YoutubeAccount>()
                        .ToList<Domain.Myfashion.Domain.YoutubeAccount>();
                        return lstmsg;
                    }
                    catch (Exception ex)
                    {
        ...
        public List<Domain.Myfashion.Domain.YoutubeAccount> getAllYoutubeAccounts()
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    List<Domain.Myfashion.Domain.YoutubeAccount> lstmsg = session.CreateQuery("from YoutubeAccount")
                         .List<Domain.Myfashion.Domain.YoutubeAccount>()
                         .ToList<Domain.Myfashion.Domain.YoutubeAccount>();
                    return lstmsg;
        ...
        public void updateYoutubeUser(Domain.Myfashion.Domain.YoutubeAccount youtubeAccount)
        {
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
