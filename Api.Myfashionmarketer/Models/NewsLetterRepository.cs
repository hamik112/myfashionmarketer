...
namespace Api.Socioboard.Model
{
    public class NewsLetterRepository : INewsLetterRepository
    {
        ...
        public void AddNewsLetter(Domain.Myfashion.Domain.NewsLetter nl)
        {
        ...
        /// </summary>
        /// <param name="nl">Set Values in a NewsLetter Class Property and Pass the Object of NewsLetter Class.(Domein.NewsLetter)</param>
        public void UpdateNewsLetter(Domain.Myfashion.Domain.NewsLetter nl)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        public List<Domain.Myfashion.Domain.NewsLetter> getAllNewsLetter()
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    List<Domain.Myfashion.Domain.NewsLetter> alstFBAccounts = session.CreateQuery("from NewsLetter").List<Domain.Myfashion.Domain.NewsLetter>().ToList<Domain.Myfashion.Domain.NewsLetter>();
        ...
        /// <returns>Return object of NewsLetter Class with  value of each member in the form of list.(List<NewsLetter>)</returns>
        public List<Domain.Myfashion.Domain.NewsLetter> GetAllNewsLetterByDate(DateTime dt)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    List<Domain.Myfashion.Domain.NewsLetter> alstFBAccounts = new List<Domain.Myfashion.Domain.NewsLetter>();
                    try
                    {
                        ...
                        alstFBAccounts = session.CreateQuery("from NewsLetter where SendDate<= :dtime and SendStatus=0").SetParameter("dtime", dt)
                                      .List<Domain.Myfashion.Domain.NewsLetter>().ToList<Domain.Myfashion.Domain.NewsLetter>();
        ...
        public Domain.Myfashion.Domain.NewsLetter getAllNewsLetterDetailsbyId(Guid nlid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        query.SetParameter("adsid", nlid);
                        Domain.Myfashion.Domain.NewsLetter grou = (Domain.Myfashion.Domain.NewsLetter)query.UniqueResult();
                        return grou;
                    }
                    catch (Exception ex)
                    {
        ...
        public List<Domain.Myfashion.Domain.NewsLetter> getAllUser()
        {
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
