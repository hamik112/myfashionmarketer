...
{
    public class TeamMemberProfileRepository 
    {
        /// <addNewTeamMember>
        /// Add New TeamMember
        /// </summary>
        ...
        public void addNewTeamMember(Domain.Myfashion.Domain.TeamMemberProfile team)
        {
        ...
        public int deleteTeamMember(Domain.Myfashion.Domain.TeamMemberProfile team)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        /// </summary>
        /// <param name="team">Set Values in a TeamMemberProfile Class Property and Pass the Object of TeamMemberProfile Class.(Domein.TeamMemberProfile)</param>
        public void updateTeamMember(Domain.Myfashion.Domain.TeamMemberProfile team)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        public List<Domain.Myfashion.Domain.TeamMemberProfile> getAllTeamMemberProfilesOfTeam(Guid TeamId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    List<Domain.Myfashion.Domain.TeamMemberProfile> alTeamMember = session.CreateQuery("from TeamMemberProfile where TeamId = :teamid")
                    .SetParameter("teamid", TeamId)
        ...
        public List<Domain.Myfashion.Domain.TeamMemberProfile> getTeamMemberProfileData(Guid TeamId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                {
                    //Proceed action, to get details of team by team id.
                    List<Domain.Myfashion.Domain.TeamMemberProfile> alstFBAccounts = session.CreateQuery("from TeamMemberProfile where TeamId = :teamid and ProfileType='facebook'")
                    .SetParameter("teamid", TeamId)
                    .List<Domain.Myfashion.Domain.TeamMemberProfile>()
                    .ToList<Domain.Myfashion.Domain.TeamMemberProfile>();
        ...
        public List<Domain.Myfashion.Domain.TeamMemberProfile> getTwtTeamMemberProfileData(Guid TeamId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                {
                    //Proceed action, to get details of team by team id.
                    List<Domain.Myfashion.Domain.TeamMemberProfile> alstFBAccounts = session.CreateQuery("from TeamMemberProfile where TeamId = :teamid and ProfileType='twitter'")
                    .SetParameter("teamid", TeamId)
                    .List<Domain.Myfashion.Domain.TeamMemberProfile>()
                    .ToList<Domain.Myfashion.Domain.TeamMemberProfile>();
        ...
        public List<Domain.Myfashion.Domain.TeamMemberProfile> getTumblrTeamMemberProfileData(Guid TeamId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                {
                    //Proceed action, to get details of team by team id.
                    List<Domain.Myfashion.Domain.TeamMemberProfile> alstFBAccounts = session.CreateQuery("from TeamMemberProfile where TeamId = :teamid and ProfileType='tumblr'")
                    .SetParameter("teamid", TeamId)
                    .List<Domain.Myfashion.Domain.TeamMemberProfile>()
                    .ToList<Domain.Myfashion.Domain.TeamMemberProfile>();
        ...
        public List<Domain.Myfashion.Domain.TeamMemberProfile> GetTeamMemberProfileByTeamIdAndProfileType(Guid TeamId, string profiletype)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                {
                    //Proceed action, to get details of team by team id.
                    List<Domain.Myfashion.Domain.TeamMemberProfile> alstFBAccounts = session.CreateQuery("from TeamMemberProfile where TeamId = :teamid and ProfileType=:profiletype")
                    .SetParameter("teamid", TeamId)
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.TeamMemberProfile> alstFBAccounts = session.CreateQuery("from TeamMemberProfile where TeamId = :teamid and ProfileId = :profileid")
                         .SetParameter("teamid", Teamid)
        ...
        public List<Domain.Myfashion.Domain.TeamMemberProfile> getAllTeamsByProfileId(string ProfileId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                {
                    //Proceed action, to get details of team by team id.
                    List<Domain.Myfashion.Domain.TeamMemberProfile> lstAllteam = session.CreateQuery("from TeamMemberProfile where ProfileId =:ProfileId")
                    .SetParameter("ProfileId", ProfileId)
                    .List<Domain.Myfashion.Domain.TeamMemberProfile>()
                    .ToList<Domain.Myfashion.Domain.TeamMemberProfile>();
        ...
        public void updateTeamMemberbyprofileid(Domain.Myfashion.Domain.TeamMemberProfile team)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
