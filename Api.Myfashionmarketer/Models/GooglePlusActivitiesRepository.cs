...
namespace Api.Myfashionmarketer.Models
{
    public class GooglePlusActivitiesRepository 
    {
        ...
        public void addgoogleplusActivity(Domain.Myfashion.Domain.GooglePlusActivities gpmsg)
        {
        ...
        public List<Domain.Myfashion.Domain.GooglePlusActivities> getAllgoogleplusActivityOfUser(Guid UserId, string profileId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.GooglePlusActivities> alst = session.CreateQuery("from GooglePlusActivities where UserId = :userid and GpUserId = :profileId")
                        .SetParameter("userid", UserId)
                        .SetParameter("profileId", profileId)
                        .List<Domain.Myfashion.Domain.GooglePlusActivities>()
                        .ToList<Domain.Myfashion.Domain.GooglePlusActivities>();
        ...
        public List<Domain.Myfashion.Domain.GooglePlusActivities> getAllgplusOfUser(string profileId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                       ...
                       // List<GooglePlusActivities> alst = session.CreateQuery("from GooglePlusActivities where UserId = :userid and GpUserId = :profileId")
                        List<Domain.Myfashion.Domain.GooglePlusActivities> alst = session.CreateQuery(str)
                      //  .SetParameter("userid", UserId)
                       // .SetParameter("profileId", profileId)
                        .List<Domain.Myfashion.Domain.GooglePlusActivities>()
                        .ToList<Domain.Myfashion.Domain.GooglePlusActivities>();
        ...
        public List<Domain.Myfashion.Domain.GooglePlusActivities> getAllgoogleplusActivityOfUser(string profileId)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.GooglePlusActivities> alst = session.CreateQuery("from GooglePlusActivities where  GpUserId = :profileId")
        ...
        public List<Domain.Myfashion.Domain.GooglePlusActivities> getgoogleplusActivity(Guid userid, string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.GooglePlusActivities> alst = session.CreateQuery("from GooglePlusActivities where UserId = :userid and GpUserId = :profileId order by PublishedDate desc")
                        .SetParameter("userid", userid)
                        .SetParameter("profileId", profileid)
                        .List<Domain.Myfashion.Domain.GooglePlusActivities>()
                        .ToList<Domain.Myfashion.Domain.GooglePlusActivities>();
