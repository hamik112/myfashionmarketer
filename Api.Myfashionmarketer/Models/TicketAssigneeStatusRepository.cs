...
namespace Api.Socioboard.Model
{
    public class TicketAssigneeStatusRepository
    {
        ...
        public void Add(Domain.Myfashion.Domain.TicketAssigneeStatus _TicketAssigneeStatus)
        {
        ...
        //public List<Domain.Myfashion.Domain.TicketAssigneeStatus> getAllAssignedMembers()
        //{
        //    //Creates a database connection and opens up a session
        //    using (NHibernate.ISession session = SessionFactory.GetNewSession())
        //    {
        ...
        //            List<Domain.Myfashion.Domain.TicketAssigneeStatus> lstAllmembersofAssigned = session.CreateQuery("from TicketAssigneeStatus")

        //            .List<Domain.Myfashion.Domain.TicketAssigneeStatus>()
        //            .ToList<Domain.Myfashion.Domain.TicketAssigneeStatus>();
        ...
        public List<Domain.Myfashion.Domain.TicketAssigneeStatus> getAllAssignedMembers()
        {
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                {
                    //Proceed action, to get details of team by team id.
                    List<Domain.Myfashion.Domain.TicketAssigneeStatus> lstAllmembersofAssigned = session.CreateQuery("from TicketAssigneeStatus order by AssignedTicketCount")
