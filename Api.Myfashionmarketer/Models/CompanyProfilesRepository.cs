...
namespace Api.Socioboard.Model
{
    ...
    {
        public bool addAccount(Domain.Myfashion.Domain.CompanyProfiles compnayProfiles)
        {
        ...
        public bool updateAccount(Domain.Myfashion.Domain.CompanyProfiles compnayProfiles)
        {
        ...
        public Domain.Myfashion.Domain.CompanyProfiles getProfiles(string Name)
        {
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    List<Domain.Myfashion.Domain.CompanyProfiles> result = (List<Domain.Myfashion.Domain.CompanyProfiles>)query.Enumerable();
