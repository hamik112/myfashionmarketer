...
namespace Api.Myfashionmarketer.Models
{
    public class TwitterFeedRepository:ITwitterFeedRepository
    {
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                       ...
                       // List<Domain.Myfashion.Domain.TwitterFeed> alst = session.CreateQuery("from TwitterFeed where UserId = :userid and ProfileId = :fbuserid")
                       // .SetParameter("userid", Userid)
                       // .SetParameter("fbuserid", ProfileId)
                       // .List<Domain.Myfashion.Domain.TwitterFeed>()
                       //.ToList<Domain.Myfashion.Domain.TwitterFeed>();
                       // if (alst.Count == 0 || alst == null)
                       //     return false;
                       // else
                       //     return true;

                        bool exist = session.Query<Domain.Myfashion.Domain.TwitterFeed>()
        ...
        public List<Domain.Myfashion.Domain.TwitterFeed> getAllTwitterUserFeeds(string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.TwitterFeed> alst = session.CreateQuery("from TwitterFeed where  ProfileId = :profileId ORDER BY FeedDate DESC")
        ...
        public List<Domain.Myfashion.Domain.TwitterFeed> getAllTwitterFeedOfUsers(Guid UserId, string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        List<Domain.Myfashion.Domain.TwitterFeed> lstmsg = session.CreateQuery("from TwitterFeed where UserId = :userid and ProfileId = :profid")
                        .SetParameter("userid", UserId)
        ...
        /// <param name="profileid">Profile id.(String)</param>
        /// <returns>Return object of TwitterFeed Class with  value of each member in the form of list.(List<TwitterFeed>)</returns>
        public List<Domain.Myfashion.Domain.TwitterFeed> getAllTwitterFeedOfUsers(Guid UserId, string profileid,int count)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        /// <param name="userid">User id.(Guid)</param>
        /// <returns>Return object of TwitterFeed Class with  value of each member in the form of list.(List<TwitterFeed>)</returns>
        public List<Domain.Myfashion.Domain.TwitterFeed> getAllTwitterFeeds(Guid userid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.TwitterFeed> lstmsg = session.CreateQuery("from TwitterFeed where UserId = :userid")
                        .SetParameter("userid", userid)
                        .List<Domain.Myfashion.Domain.TwitterFeed>()
                        .ToList<Domain.Myfashion.Domain.TwitterFeed>();
                        return lstmsg;
        ...
        /// <returns>Return object of TwitterFeed Class with  value of each member in the form of list.(List<TwitterFeed>)</returns>
        public List<Domain.Myfashion.Domain.TwitterFeed> getTwitterFeedOfUsers(Guid UserId, string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.TwitterFeed> lstmsg = session.CreateQuery("from TwitterFeed where UserId = :userid and ProfileId = :profid and Type ='twt_feeds'")
                        .SetParameter("userid", UserId)
                        .SetParameter("profid", profileid)
                        .List<Domain.Myfashion.Domain.TwitterFeed>()
                        .ToList<Domain.Myfashion.Domain.TwitterFeed>();
        ...
        /// <param name="profileid">Profile id.(String)</param>
        /// <returns>Return object of TwitterFeed Class with  value of each member in the form of list.(List<TwitterFeed>)</returns>
        public List<Domain.Myfashion.Domain.TwitterFeed> getTwitterMentionsOfUser(Guid userId, string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    {
                        //Proceed action, to get feeds by user id and profile id.
                        List<Domain.Myfashion.Domain.TwitterFeed> lstmsg = session.CreateQuery("from TwitterFeed where UserId = :userid and ProfileId = :profid and Type ='twt_mentions'")
                        .SetParameter("userid", userId)
                        .SetParameter("profid", profileid)
                        .List<Domain.Myfashion.Domain.TwitterFeed>()
                        .ToList<Domain.Myfashion.Domain.TwitterFeed>();
        ...
        /// <param name="profileid">profile id.(string)</param>
        /// <returns>Return object of TwitterFeed Class with  value of each member in the form of list.(List<TwitterFeed>)</returns>
        public List<Domain.Myfashion.Domain.TwitterFeed> getTwitterFeedOfProfile(string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.TwitterFeed> lstmsg = session.CreateQuery("from TwitterFeed where ProfileId = :profid and Type ='twt_feeds' order by FeedDate desc")
        ...
        /// <param name="profileid">Profile id.(String)</param>
        /// <returns>Return object of TwitterFeed Class with  value of each member in the form of list.(List<TwitterFeed>)</returns>
        public List<Domain.Myfashion.Domain.TwitterFeed> getTwitterMentionsOfProfile(string profileid)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.TwitterFeed> lstmsg = session.CreateQuery("from TwitterFeed where ProfileId = :profid and Type ='twt_mentions'")
                         .SetParameter("profid", profileid)
                         .List<Domain.Myfashion.Domain.TwitterFeed>()
                         .ToList<Domain.Myfashion.Domain.TwitterFeed>();
            ...
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    try
                    {
                       ...
                       // str += ")";
                       // List<Domain.Myfashion.Domain.TwitterFeed> alst = session.CreateQuery(str)
                       //.SetParameter("userid", userid)
                       //.List<Domain.Myfashion.Domain.TwitterFeed>().Where(d=>d.FeedDate.Date>=AssinDate.Date)
                       //.ToList<Domain.Myfashion.Domain.TwitterFeed>();
                       // return alst;

                        string[] arrsrt = profileid.Split(',');

                        int alst = session.Query<Domain.Myfashion.Domain.TwitterFeed>().Where(x => x.UserId.Equals(userid) && arrsrt.Contains(x.ProfileId) && x.FeedDate.Date>=AssinDate.Date).Count()//.CreateQuery("from FacebookFeed where  UserId = :UserId and FeedDescription like %' =:keyword '% ORDER BY FeedDate DESC")
                       ;
        ...
        /// <param name="profileid">Profile id.(String)</param>
        /// <returns>Return object of TwitterFeed Class with  value of each member in the form of list.(List<TwitterFeed>)</returns>
        public List<Domain.Myfashion.Domain.TwitterFeed> getAllTwitterFeedOfUsersByKeyword(string UserId, string profileid, string keyword, int count)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    try
                    {
                        ...
                        List<Domain.Myfashion.Domain.TwitterFeed> lstmsg = session.Query<Domain.Myfashion.Domain.TwitterFeed>().Where(x => x.Feed.Contains(keyword) && x.UserId.Equals(Guid.Parse(UserId)) && x.ProfileId.Equals(profileid)).OrderByDescending(x => x.FeedDate).Take(20)//.CreateQuery("from FacebookFeed where  UserId = :UserId and FeedDescription like %' =:keyword '% ORDER BY FeedDate DESC")
        ...
        public List<Domain.Myfashion.Domain.TwitterFeed> getAllFeedsOfSBUserWithRangeAndProfileId(string UserId, string profileId, string noOfDataToSkip, string noOfResultsFromTop)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
        ...
        /// <param name="profileid">Profile id</param>
        /// <returns>List of Facebbok feeds (List<FacebookFeed>)</returns>
        public List<Domain.Myfashion.Domain.TwitterFeed> getAllFeedsOfSBUserWithRangeByProfileId(string profileid, string noOfDataToSkip, string noOfResultsFromTop)
        {
            //Creates a database connection and opens up a session
            using (NHibernate.ISession session = SessionFactory.GetNewSession())
            {
                ...
                using (NHibernate.ITransaction transaction = session.BeginTransaction())
                {
                    ...
                    {
                        //Proceed action, to get all facebook feeds of profile by facebook profile id  
                        List<Domain.Myfashion.Domain.TwitterFeed> alst = session.Query<Domain.Myfashion.Domain.TwitterFeed>().Where(x => x.ProfileId.Equals(profileid)).OrderByDescending(x => x.FeedDate).Skip(Convert.ToInt32(noOfDataToSkip)).Take(Convert.ToInt32(noOfResultsFromTop))//.CreateQuery("from FacebookFeed where  UserId = :UserId and FeedDescription like %' =:keyword '% ORDER BY FeedDate DESC")
                        .ToList<Domain.Myfashion.Domain.TwitterFeed>();
