...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class SocialProfile : System.Web.Services.WebService
    {
        ...
        Domain.Myfashion.Domain.SocialProfile socialprofile = new Domain.Myfashion.Domain.SocialProfile();
        ...
        public string GetSocialProfileByUserId(string UserId)
        {
            try
            {
                List<Domain.Myfashion.Domain.SocialProfile> lstSocialProfile = objSocialProfilesRepository.getAllSocialProfilesOfUser(Guid.Parse(UserId));
        ...
        public string SocialProfileByProfilType(string Profiletype)
        {
            try
            {
                List<Domain.Myfashion.Domain.SocialProfile> lstSocialProfile = objSocialProfilesRepository.GetSocialProfileByProfileType(Profiletype);
                return new JavaScriptSerializer().Serialize(lstSocialProfile);
            }
            catch (Exception ex)
            {
        ...
        public string GetAllSocialProfilesOfUserCount(string UserId)
        {
            try
            {
                ...
                List<Domain.Myfashion.Domain.SocialProfile> lstSocialProfile = new List<Domain.Myfashion.Domain.SocialProfile>();
