...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class InstagramAccount : System.Web.Services.WebService
    {
        ...
        {
            List<Domain.Myfashion.Domain.InstagramAccount> objInstagramAccount = objLinkedInAccountRepository.GetAllInstagramAccountsOfUser(Guid.Parse(Userid));
        ...
        public string GetAllInstagramAccountsByUserIdAndGroupId(string userid, string groupid)
        {
            try
            {
                List<Domain.Myfashion.Domain.InstagramAccount> lstInstagramAccount = new List<Domain.Myfashion.Domain.InstagramAccount>();
                Domain.Myfashion.Domain.Team objTeam = objTeamRepository.GetTeamByGroupId(Guid.Parse(groupid));
                List<Domain.Myfashion.Domain.TeamMemberProfile> lstTeamMemberProfile = objTeamMemberProfileRepository.GetTeamMemberProfileByTeamIdAndProfileType(objTeam.Id, "instagram");
