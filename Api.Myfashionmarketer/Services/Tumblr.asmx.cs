...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class Tumblr : System.Web.Services.WebService
    {
        ...
        Domain.Myfashion.Domain.TumblrAccount objTumblrAccount;
        TumblrFeedRepository objTumblrFeedRepository = new TumblrFeedRepository();
        Domain.Myfashion.Domain.TumblrFeed objTumblrFeed;
        ...
        public string TumblerData(string tumblrusername)
        {
            ...
            try
            {
                ...
                Domain.Myfashion.Domain.TumblerData objDomainTumblerData = new Domain.Myfashion.Domain.TumblerData();
        ...
        {
            string ret = "";
            Domain.Myfashion.Domain.TumblrAccount objTumblrAccount = objTumblrAccountRepository.getTumblrAccountDetailsById(profileid, Guid.Parse(userid));
            oAuthTumbler Obj_oAuthTumbler = new oAuthTumbler();
            oAuthTumbler.TumblrToken = objTumblrAccount.tblrAccessToken;
            oAuthTumbler.TumblrTokenSecret = objTumblrAccount.tblrAccessTokenSecret;
            PublishedPosts objPublishedPosts = new PublishedPosts();
        ...
        {
            Domain.Myfashion.Domain.TumblrAccount ObjTumblrAccount = (Domain.Myfashion.Domain.TumblrAccount)(new JavaScriptSerializer().Deserialize(ObjTumblr, typeof(Domain.Myfashion.Domain.TumblrAccount)));
            try
            {
