...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class Facebook : System.Web.Services.WebService
    {
        ...
        Domain.Myfashion.Domain.AddFacebookPage objFacebookPage;
        FbPagePostRepository objFbPagePostRepository = new FbPagePostRepository();
        Domain.Myfashion.Domain.FbPagePost objFbPagePost = new Domain.Myfashion.Domain.FbPagePost();
        FbPageCommentRepository objFbPageCommentRepository = new FbPageCommentRepository();
        Domain.Myfashion.Domain.FbPageComment objFbPageComment = new Domain.Myfashion.Domain.FbPageComment();
        FbPagePostCommentLikerRepository objFbPagePostCommentLikerRepository = new FbPagePostCommentLikerRepository();
        Domain.Myfashion.Domain.FbPagePostCommentLiker objFbPagePostCommentLiker = new FbPagePostCommentLiker();
        FbPageLikerRepository objFbPageLikerRepository = new FbPageLikerRepository();
        Domain.Myfashion.Domain.FbPageLiker objFbPageLiker = new Domain.Myfashion.Domain.FbPageLiker();
        ...
        private void UpdateFacebookAccount(Domain.Myfashion.Domain.FacebookAccount objFacebookAccount)
        {
            objFacebookAccountRepository.updateFacebookUser(objFacebookAccount);
        }
        ...
        private List<Domain.Myfashion.Domain.FacebookFeed> AddFacebookFeeds(string UserId, FacebookClient fb, dynamic profile)
        {
            //List of new Feeds
            List<Domain.Myfashion.Domain.FacebookFeed> lstFacebookFeeds = new List<Domain.Myfashion.Domain.FacebookFeed>();

            try
            {

                Domain.Myfashion.Domain.FacebookFeed objFacebookFeed = new Domain.Myfashion.Domain.FacebookFeed();
                System.Net.ServicePointManager.SecurityProtocol = System.Net.SecurityProtocolType.Tls;
                ...
                //for (int i = 0; i < 10; i++)
                {
                    ...
                    if (feeds != null)
                    {
                        ...
                        {
                            objFacebookFeed = new Domain.Myfashion.Domain.FacebookFeed();
        ...
        public string GetFacebookGroups(string code)
        {
            ...
            if (accessToken != null)
            {
                ...
                foreach (var item in output["data"])
                {
                    try
                    {
                        Domain.Myfashion.Domain.AddFacebookGroup objAddFacebookGroup = new Domain.Myfashion.Domain.AddFacebookGroup();
        ...
        public string AddFbPagePost(string userid, string accesstoken, string profileid)
        {
            ...
            try
            {
                ...
                {
                    objFbPagePost = new Domain.Myfashion.Domain.FbPagePost();
        ...
        public string GetAllFbPagePostDetails(string pageid, string userid)
        {
            try
            {
                List<Domain.Myfashion.Domain.FbPagePost> _FbPagePost = objFbPagePostRepository.getAllPost(pageid, Guid.Parse(userid));
        ...
        {
            objFacebookAccount = new Domain.Myfashion.Domain.FacebookAccount();
            Domain.Myfashion.Domain.FacebookAccount FacebookAccount = new Domain.Myfashion.Domain.FacebookAccount();
        ...
        public string AddAllFbPagePost(string userid, string accesstoken, string profileid)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(accesstoken))
                {
                    try
                    {
                        _facebookAccount = (Domain.Myfashion.Domain.FacebookAccount)(new System.Web.Script.Serialization.JavaScriptSerializer().Deserialize(_FacebookAccount.getFacebookAccountDetailsById(userid, profileid), typeof(Domain.Myfashion.Domain.FacebookAccount)));
        ...
        {
            Domain.Myfashion.Domain.FacebookAccount objFacebookAccount = (Domain.Myfashion.Domain.FacebookAccount)(new JavaScriptSerializer().Deserialize(ObjFacebook, typeof(Domain.Myfashion.Domain.FacebookAccount)));
            try
            {
                objFacebookAccountRepository.updateFacebookUser(objFacebookAccount);
        ...
        public string TicketFacebokReply(String message, String profileid, string commentid)
        {
            ...
            try
            {
                Domain.Myfashion.Domain.FacebookAccount objFacebookAccount = objFacebookAccountRepository.getFacebookAccountDetailsById(profileid);
                FacebookClient fb = new FacebookClient();
                fb.AccessToken = objFacebookAccount.AccessToken;
                var args = new Dictionary<string, object>();
                args["message"] = message;
        ...
        public string AddNewFacebookFeeds(string FbId, string UserId)
        {
            ...
            List<Domain.Myfashion.Domain.FacebookFeed> lstNewFacebookFeeds = new List<Domain.Myfashion.Domain.FacebookFeed>();
        ...
        public void getPageConversations(string UserId, FacebookClient fb, dynamic profile)
        {
            try
            {
                ...
                Domain.Myfashion.Domain.TwitterDirectMessages _TwitterDirectMessages;
                dynamic data = fb.Get("v2.0/me/conversations");
                foreach (var item in data["data"])
                {
                    foreach (var msg_item in item["messages"]["data"])
                    {
                        _TwitterDirectMessages = new Domain.Myfashion.Domain.TwitterDirectMessages();
        ...
        //Added By Sumit Gupta[15-02-15]
        private List<Domain.Myfashion.Domain.FacebookMessage> AddNewFacebookUserHome(string UserId, FacebookClient fb, dynamic profile)
        {
            List<Domain.Myfashion.Domain.FacebookMessage> lstFacebookMessage = new List<Domain.Myfashion.Domain.FacebookMessage>();

            Domain.Myfashion.Domain.FacebookMessage objFacebookMessage = new Domain.Myfashion.Domain.FacebookMessage();
            try
            {
                dynamic home = fb.Get("v2.0/me/home");
                if (home != null)
