...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class Dropbox : System.Web.Services.WebService
    {
        ...
        public string GetUserDropBoxData(string UserId)
        {
            ...
            Api.Myfashionmarketer.Models.DropboxAccount _DropboxAccount = new DropboxAccount();

            Domain.Myfashion.Domain.DropboxAccount _DropboxUserAccount = new Domain.Myfashion.Domain.DropboxAccount();

            _DropboxUserAccount = Newtonsoft.Json.JsonConvert.DeserializeObject<Domain.Myfashion.Domain.DropboxAccount>(_DropboxAccount.GetDropboxAccountDetailsByUserId(UserId));
        ...
        public string AddDropboxAccount(string code, string UserId)
        {
            ...
            Domain.Myfashion.Domain.DropboxAccount _DropboxAccount = new Domain.Myfashion.Domain.DropboxAccount();
