...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class CompanyDashboard : System.Web.Services.WebService
    {
        ...
        // Domain.Myfashion.Domain.facebookpageevents ObjFbPageEvent = new Domain.Myfashion.Domain.facebookpageevents();
        ...
        private Domain.Myfashion.Domain.CompanyProfiles ObjCompanyProfiles = new Domain.Myfashion.Domain.CompanyProfiles();
        ...
        //[WebMethod]
        //[ScriptMethod(UseHttpGet = false, ResponseFormat = ResponseFormat.Json)]
        public Domain.Myfashion.Domain.CompanyProfiles AddCompanyInfo(string name)
        {
            string ret = string.Empty;
            Domain.Myfashion.Domain.CompanyProfiles companyProfile = new Domain.Myfashion.Domain.CompanyProfiles();
        ...
        public string getCompanyProfile(string keyword)
        {
            ...
            try
            {
                Domain.Myfashion.Domain.CompanyProfiles objCompanyName = ObjCompanySocialProfilesRepository.SearchCompanyName(keyword);
        ...
        public string GetCompanyProfile(string id)
        {
            ...
            try
            {
                Domain.Myfashion.Domain.CompanyProfiles objCompanyProfiles = ObjCompanySocialProfilesRepository.getCompanyProfiles(Guid.Parse(id));
