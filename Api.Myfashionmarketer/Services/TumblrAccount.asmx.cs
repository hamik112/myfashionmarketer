...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class TumblrAccount : System.Web.Services.WebService
    {
        ...
        public string GetTumblrAccountDetailsById(string UserId, string ProfileId)
        {
            try
            {
                Domain.Myfashion.Domain.TumblrAccount objTumblrAccount=new Domain.Myfashion.Domain.TumblrAccount ();
        ...
        public string GetAllTumblrAccountsOfUser(string UserId)
        {
            try
            {
                List<Domain.Myfashion.Domain.TumblrAccount> lstTumblrAccount = objTumblrAccountRepository.getTumblrAccountDetailsById(Guid.Parse(UserId));
        ...
        public string GetAllTumblrAccountsByUserIdAndGroupId(string userid, string groupid)
        {
            try
            {
                List<Domain.Myfashion.Domain.TumblrAccount> lstTumblrAccount = new List<Domain.Myfashion.Domain.TumblrAccount>();
                Domain.Myfashion.Domain.Team objTeam = objTeamRepository.GetTeamByGroupId(Guid.Parse(groupid));
                List<Domain.Myfashion.Domain.TeamMemberProfile> lstTeamMemberProfile = objTeamMemberProfileRepository.GetTeamMemberProfileByTeamIdAndProfileType(objTeam.Id, "tumblr");
