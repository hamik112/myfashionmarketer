...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class TwitterMessage : System.Web.Services.WebService
    {
        ...
        {
            List<Domain.Myfashion.Domain.TwitterMessage> lsttwtmsg = objTwitterMessageRepository.getAllTwitterMessagesOfUser(Guid.Parse(Userid), TwitterId);
        ...
        {
            List<Domain.Myfashion.Domain.TwitterMessage> lsttwtmsg = objTwitterMessageRepository.getAllTwitterMessagesOfUser(Guid.Parse(Userid), TwitterId, count);
            return new JavaScriptSerializer().Serialize(lsttwtmsg);
        }
        ...
        {
            List<Domain.Myfashion.Domain.TwitterMessage> lsttwtmsg = objTwitterMessageRepository.getUnreadMessages(Profileid);
            return new JavaScriptSerializer().Serialize(lsttwtmsg);
        }
        ...
        {
            List<Domain.Myfashion.Domain.TwitterMessage> lsttwtmsg = objTwitterMessageRepository.getAlltwtMessagesOfUser(Profileid);
            return new JavaScriptSerializer().Serialize(lsttwtmsg);
        }
        ...
        {
            List<Domain.Myfashion.Domain.TwitterMessage> lsttwtmsg = objTwitterMessageRepository.getAlltwtMessages(Profileid);
            return new JavaScriptSerializer().Serialize(lsttwtmsg);
        }
        ...
        {
            List<Domain.Myfashion.Domain.TwitterMessage> lsttwtmsg = objTwitterMessageRepository.getAlltwtMessages1(Profileid, Guid.Parse(userid));
            return new JavaScriptSerializer().Serialize(lsttwtmsg);
        }
        ...
        public string getAllTwitterUsertweetOfUsers(string UserId, string ProfileId)
        {
            try
            {
                List<Domain.Myfashion.Domain.TwitterMessage> lstTwitterUsertweet = objTwitterMessageRepository.getAllTwitterUsertweetOfUsers(Guid.Parse(UserId), ProfileId);
        ...
        public string getAllTwitterRetweetOfUsers(string UserId, string ProfileId)
        {
            try
            {
                List<Domain.Myfashion.Domain.TwitterMessage> lstTwitterRetweet = objTwitterMessageRepository.getAllTwitterRetweetOfUsers(Guid.Parse(UserId), ProfileId);
        ...
        public string getAllTwitterMentionsOfUsers(string UserId, string ProfileId)
        {
            try
            {
                List<Domain.Myfashion.Domain.TwitterMessage> lstTwitterMentions = objTwitterMessageRepository.getAllTwitterMentionsOfUsers(Guid.Parse(UserId), ProfileId);
        ...
        public string GetTwitterMessageByMessageId(string userid, string Msgid)
        {
            try
            {
                Domain.Myfashion.Domain.TwitterMessage _TwitterMessage = objTwitterMessageRepository.GetTwitterMessageByMessageId(Guid.Parse(userid), Msgid);
        ...
        public string getAllTwitterUsertweetOfUsersByKeyword(string UserId, string ProfileId, string keyword)
        {
            try
            {
                List<Domain.Myfashion.Domain.TwitterMessage> lstTwitterUsertweet = objTwitterMessageRepository.getAllTwitterUsertweetOfUsersByKeyword(UserId, ProfileId, keyword);
                return new JavaScriptSerializer().Serialize(lstTwitterUsertweet);
            }
            catch (Exception ex)
            {
        ...
        public string getAllTwitterRetweetOfUsersByKeyword(string UserId, string ProfileId, string keyword)
        {
            try
            {
                List<Domain.Myfashion.Domain.TwitterMessage> lstTwitterRetweet = objTwitterMessageRepository.getAllTwitterRetweetOfUsersByKeyword(UserId, ProfileId, keyword);
                return new JavaScriptSerializer().Serialize(lstTwitterRetweet);
            }
            catch (Exception ex)
            {
        ...
        public string getAllTwitterMentionsOfUsersByKeyword(string UserId, string ProfileId, string keyword)
        {
            try
            {
                List<Domain.Myfashion.Domain.TwitterMessage> lstTwitterMentions = objTwitterMessageRepository.getAllTwitterMentionsOfUsersByKeyword(UserId, ProfileId, keyword);
                return new JavaScriptSerializer().Serialize(lstTwitterMentions);
            }
            catch (Exception ex)
            {
        ...
        {
            List<Domain.Myfashion.Domain.TwitterMessage> lsttwtmsg = objTwitterMessageRepository.getAllTwitterMessagesOfUserByKeyword(Userid, TwitterId, keyword, count);
            return new JavaScriptSerializer().Serialize(lsttwtmsg);
        }
        ...
        {
            List<Domain.Myfashion.Domain.TwitterMessage> lsttwtmsg = objTwitterMessageRepository.getAllTwitterkMessagesOfUserByProfileIdWithRange(Guid.Parse(UserId), profileid, noOfDataToSkip);
            return new JavaScriptSerializer().Serialize(lsttwtmsg);
        }
        ...
        {
            List<Domain.Myfashion.Domain.TwitterMessage> lsttwtmsg = objTwitterMessageRepository.GetAllMessageDetailWithRange(Guid.Parse(UserId), profileid, noOfDataToSkip);
            return new JavaScriptSerializer().Serialize(lsttwtmsg);
        }
    }
}
