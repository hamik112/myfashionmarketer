...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class LinkedinCompanyPage : System.Web.Services.WebService
    {
        ...
        public string GetAllLinkedinCompanyPagePostsByUserIdAndProfileId(string UserId, string LinkedinPageId)
        {
            try
            {
                List<Domain.Myfashion.Domain.LinkedinCompanyPagePosts> lstlinkedinCompanyPagePost = objlinkedpagepostrepo.getAllLinkedInPagePostsOfUser(Guid.Parse(UserId), LinkedinPageId);
