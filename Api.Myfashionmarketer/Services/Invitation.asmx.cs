...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class Invitation : System.Web.Services.WebService
    {
        ...
        //    Domain.Myfashion.Domain.User _user = userRepo.getUserInfoByEmail(SenderEmail);
        ...
        //    //Domain.Myfashion.Domain.Invitation objInvite = new Domain.Myfashion.Domain.Invitation();
        //    //Domain.Myfashion.Domain.User _user = userRepo.getUserInfoByEmail(SenderEmail);
