...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class GooglePlusActivities : System.Web.Services.WebService
    {
        ...
        {
            List<Domain.Myfashion.Domain.GooglePlusActivities> lstGooglePlusActivities = objGooglePlusActivitiesRepository.getgoogleplusActivity(Guid.Parse(UserId),ProfileId);
