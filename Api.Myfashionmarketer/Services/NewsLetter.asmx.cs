...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class NewsLetter : System.Web.Services.WebService
    {
        ...
        Domain.Myfashion.Domain.NewsLetter ObjNewsLetter = new Domain.Myfashion.Domain.NewsLetter();
        ...
        public string GetAllNewsLetters()
        {
            ...
            try
            {
                List<Domain.Myfashion.Domain.NewsLetter> lstNewsLetter = new List<Domain.Myfashion.Domain.NewsLetter>();
                lstNewsLetter = ObjNewsLetterRepository.getAllNewsLetters();
                foreach (Domain.Myfashion.Domain.NewsLetter item in lstNewsLetter)
                {
        ...
        public string AddNewsLatter(string ObjNewsLatter)
        {
            try
            {
                Domain.Myfashion.Domain.NewsLetter objnewsLatter = (Domain.Myfashion.Domain.NewsLetter)(new JavaScriptSerializer().Deserialize(ObjNewsLatter, typeof(Domain.Myfashion.Domain.NewsLetter)));
