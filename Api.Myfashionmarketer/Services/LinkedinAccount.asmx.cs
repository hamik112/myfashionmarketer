    ...
    public class LinkedinAccount : System.Web.Services.WebService
    {
        ...
        public string UserInformation(string UserId, string LinkedinId)
        {
            try
            {
                ...
                Domain.Myfashion.Domain.LinkedInAccount LinkedAccount = objlinkedinaccrepo.getUserInformation(Userid, LinkedinId);
        ...
        public string GetAllLinkedinAccountsOfUser(string UserId)
        {
            try
            {
                List<Domain.Myfashion.Domain.LinkedInAccount> objLinkedInAccount = objlinkedinaccrepo.GetAllLinkedinAccountsOfUser(Guid.Parse(UserId));
