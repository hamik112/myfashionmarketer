...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class Linkedin : System.Web.Services.WebService
    {
        ...
        Domain.Myfashion.Domain.Team objteam;
        TeamMemberProfileRepository objTeamMemberProfileRepository = new TeamMemberProfileRepository();
        Domain.Myfashion.Domain.TeamMemberProfile objTeamMemberProfile;
        SocialProfilesRepository objSocialProfilesRepository = new SocialProfilesRepository();
        Domain.Myfashion.Domain.SocialProfile objSocialProfile;
        LinkedInAccountRepository objLinkedInAccountRepository = new LinkedInAccountRepository();
        Domain.Myfashion.Domain.LinkedInAccount objLinkedInAccount;
        LinkedInFeedRepository objLinkedInFeedRepository = new LinkedInFeedRepository();
        Domain.Myfashion.Domain.LinkedInFeed objLinkedInFeed;
        ...
        Domain.Myfashion.Domain.LinkedInMessage objLinkedInMessage;
        ...
        public string GetLinkedGroupsDetail(string profileid,string userid)
        {
            ...
            List<Domain.Myfashion.Domain.LinkedInGroup.Group_Updates> lst = l.GetGroupUpdates(oauthlin, 20);
            return new JavaScriptSerializer().Serialize(lst);
        ...
        public string PostLinkedInGroupFeeds(string gid, string linkedInUserId, string msg, string title, string userid) 
        {
         ...
         public void GetLinkedInFeeds(oAuthLinkedIn _oauth, string profileId, Guid userId)
         {
             ...
             List<LinkedInNetwork.Network_Updates> userUPdate = objln.GetNetworkUpdates(_oauth, 20);
             Domain.Myfashion.Domain.LinkedInFeed lnkfeeds = new Domain.Myfashion.Domain.LinkedInFeed();
             foreach (var item in userUPdate)
             {
         ...
         {
             Domain.Myfashion.Domain.LinkedInAccount objLinkedinAccount = (Domain.Myfashion.Domain.LinkedInAccount)(new JavaScriptSerializer().Deserialize(ObjLinkedin, typeof(Domain.Myfashion.Domain.LinkedInAccount)));
             try
             {
