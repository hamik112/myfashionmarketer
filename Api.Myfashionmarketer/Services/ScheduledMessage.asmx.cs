...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class ScheduledMessage : System.Web.Services.WebService
    {
        ...
        {
            List<Domain.Myfashion.Domain.ScheduledMessage> _ScheduledMessage = new List<Domain.Myfashion.Domain.ScheduledMessage>();
            try
            {
        ...
        public string GetAllScheduleMsgDetailsForReport(string userid, string profileid, string days)
        {
            ...
            try
            {
              ...
              foreach (Domain.Myfashion.Domain.ScheduledMessage item in _ScheduledMessage)
              {
        ...
        {
            List<Domain.Myfashion.Helper.ScheduledTracker> _AllScheduledMessage = new List<Domain.Myfashion.Helper.ScheduledTracker>();
            try
            {
