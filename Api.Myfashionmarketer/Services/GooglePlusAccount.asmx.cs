...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class GooglePlusAccount : System.Web.Services.WebService
    {
        ...
        public string GetGooglePlusAccountDetailsById(string UserId, string ProfileId)
        {
            try
            {
                Domain.Myfashion.Domain.GooglePlusAccount objGpAccount = ObjGooglePlusAccountsRepo.getGooglePlusAccountDetailsById(ProfileId, Guid.Parse(UserId));
        ...
        {
            Domain.Myfashion.Domain.GooglePlusAccount ObjGooglePlusAccount = (Domain.Myfashion.Domain.GooglePlusAccount)(new JavaScriptSerializer().Deserialize(ObjGooglePlus, typeof(Domain.Myfashion.Domain.GooglePlusAccount)));
            try
            {
