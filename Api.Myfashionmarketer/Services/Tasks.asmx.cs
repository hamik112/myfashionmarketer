...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class Tasks : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public void CreateNewTask(string description, string userid, Domain.Myfashion.Domain.Tasks task, string assigntoId, string comment)
        {
            string descritption = description;
            Guid idtoassign = Guid.Empty;
            idtoassign = Guid.Parse(assigntoId);

            Domain.Myfashion.Domain.Tasks objTask = task;
        ...
        {
            List<Domain.Myfashion.Domain.TaskComment> lstTaskComment = new List<Domain.Myfashion.Domain.TaskComment>();
            TaskRepository taskrepo = new TaskRepository();
        ...
        //addTask
        [WebMethod]
        public void addTask(string description, string userid, Domain.Myfashion.Domain.Tasks task, string assigntoId, string comment, string AssignDate)
        {
            string descritption = description;
            Guid idtoassign = Guid.Empty;
            idtoassign = Guid.Parse(assigntoId);
        ...
        //addTask
        [WebMethod]
        public void AddNewTaskWithGroup(string description,string messagedate, string userid, Domain.Myfashion.Domain.Tasks task, string assigntoId, string comment, string AssignDate, string groupid)
        {
            string descritption = description;
            Guid idtoassign = Guid.Empty;
            idtoassign = Guid.Parse(assigntoId);
        ...
        public string GetAllIncompleteTaskofUser(string userid, string groupid)
        {
            ...
            foreach (Domain.Myfashion.Domain.Tasks item in taskrepo.getAllIncompleteTasksOfUsers(Guid.Parse(userid)))
            {
                TaskData.Add(item);
            }
            List<Domain.Myfashion.Domain.Tasks> taskdata = new List<Domain.Myfashion.Domain.Tasks>();
        ...
        public string GetAllCompleteTaskofUser(string userid, string groupid)
        {
            ...
            foreach (Domain.Myfashion.Domain.Tasks item in taskrepo.getAllCompleteTasksOfUsers(Guid.Parse(userid), Guid.Parse(groupid)))
            {
                TaskData.Add(item);
            }
            List<Domain.Myfashion.Domain.Tasks> taskdata = new List<Domain.Myfashion.Domain.Tasks>();
