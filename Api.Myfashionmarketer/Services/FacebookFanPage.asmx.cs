...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class FacebookFanPage : System.Web.Services.WebService
    {
        ...
        public int FacebookFans(string userid, string profileid, string days)
        {
            ...
            int count = 0;
            int Totalcount = 0;
            Domain.Myfashion.Domain.FacebookFanPage lstFacebookFanPage = new Domain.Myfashion.Domain.FacebookFanPage();
            Domain.Myfashion.Domain.FacebookFanPage lstFacebookFancount = new Domain.Myfashion.Domain.FacebookFanPage();
            try
            {
