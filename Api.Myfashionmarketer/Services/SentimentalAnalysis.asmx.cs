...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class SentimentalAnalysis : System.Web.Services.WebService
    {
        ...
        Domain.Myfashion.Domain.FeedSentimentalAnalysis _FeedSentimentalAnalysis = new FeedSentimentalAnalysis();
        ...
        //    try
        //    {
        //        List<Domain.Myfashion.Domain.FeedSentimentalAnalysis> lstAllProfiles = new List<Domain.Myfashion.Domain.FeedSentimentalAnalysis>();
        //        List<Domain.Myfashion.Domain.FeedSentimentalAnalysis> lstNegativeFeedsOfProfile = new List<Domain.Myfashion.Domain.FeedSentimentalAnalysis>();
        //        List<Domain.Myfashion.Domain.FeedSentimentalAnalysis> lstNegativeFeedsOfAllProfile = new List<Domain.Myfashion.Domain.FeedSentimentalAnalysis>();
