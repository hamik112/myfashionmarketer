...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class YoutubeAccount : System.Web.Services.WebService
    {
        ...
        public string GetAllYoutubeAccountDetailsById(string UserId)
        {
            try
            {
                List<Domain.Myfashion.Domain.YoutubeAccount> lstYoutubeAccount = objYoutubeAccountRepository.getYoutubeAccountDetailsById(Guid.Parse(UserId));
        ...
        public string GetAllYoutubeAccountsByUserIdAndGroupId(string userid, string groupid)
        {
            try
            {
                List<Domain.Myfashion.Domain.YoutubeAccount> lstYoutubeAccount = new List<Domain.Myfashion.Domain.YoutubeAccount>();
                Domain.Myfashion.Domain.Team objTeam = objTeamRepository.GetTeamByGroupId(Guid.Parse(groupid));
                List<Domain.Myfashion.Domain.TeamMemberProfile> lstTeamMemberProfile = objTeamMemberProfileRepository.GetTeamMemberProfileByTeamIdAndProfileType(objTeam.Id, "youtube");
        ...
        public string GetAllYoutubeAccounts()
        {
            try
            {
                ...
                List<Domain.Myfashion.Domain.YoutubeAccount> lstYoutubeAcc = objyoutube.getAllYoutubeAccounts();
