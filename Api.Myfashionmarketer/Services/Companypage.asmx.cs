...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class Companypage : System.Web.Services.WebService
    {
        ...
        {
            Domain.Myfashion.Domain.FacebookAccount fbaccount = null;
            ...
            //Domain.Myfashion.Domain.facebookpageinfo fbPageInfo = new Domain.Myfashion.Domain.facebookpageinfo();
        ...
        public string LinkedinSearch(string keyword)
        {
            ...
            try
            {
                ...
                //Domain.Myfashion.Domain.LinkedInAccount linkacc = (Domain.Myfashion.Domain.LinkedInAccount)alstLIAccounts[0];
        ...
        public string InstagramSearch(string keyword, string WebUrl)
        {
            ...
            try
            {
                ...
                Domain.Myfashion.Domain.InstagramAccount instaacc = (Domain.Myfashion.Domain.InstagramAccount)arrList[0];
        ...
        public string InstagramSingleUser(string UserId)
        {
            ...
            try
            {
                ...
                AccessToken access = new AccessToken();
                ArrayList arrList = instagramRepo.getAllInstagramAccounts();
                Domain.Myfashion.Domain.InstagramAccount instaacc = (Domain.Myfashion.Domain.InstagramAccount)arrList[1];
                string tk = instaacc.AccessToken;
        ...
        public string TumblrSearch(string keyword)
        {
            ...
            try
            {
                ...
                Domain.Myfashion.Domain.TumblrAccount TumComAcc = tumaccrepo.getTumblrAccountDetailsById(keyword);
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        Domain.Myfashion.Domain.TumblrAccount newtumbobj = new Domain.Myfashion.Domain.TumblrAccount();
        ...
        public string YoutubeSearch(string keyword)
        {
            ...
            //Domain.Myfashion.Domain.YoutubeAccount ytAccount = ytAccrepo.getYoutubeAccountDetailsByUserName(keyword);
            ...
            //else
            {
                ...
                try
                {
                    ...
                    //Domain.Myfashion.Domain.YoutubeAccount ytnewacc = new Domain.Myfashion.Domain.YoutubeAccount();
        ...
        public string GooglePlusSearch(string keyword)
        {
            ...
            //Domain.Myfashion.Domain.GooglePlusAccount gpacc = null;
            //try
            //{
            ...
            //else
            {
                ...
                try
                {
                    ...
                    //if (gpacc == null)
                    //{
                    //    Domain.Myfashion.Domain.GooglePlusAccount newgplusacc = new Domain.Myfashion.Domain.GooglePlusAccount();
