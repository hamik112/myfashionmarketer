...
namespace Api.Myfashionmarketer.Models
{
    ...
    {
        Domain.Myfashion.Domain.TicketAssigneeStatus objTicketAssigneeStatus = new Domain.Myfashion.Domain.TicketAssigneeStatus();
        ...
        public string getAllAssignedMembers()
        {
            try
            {
                List<Domain.Myfashion.Domain.TicketAssigneeStatus> lstAllmembersofAssigned = new List<Domain.Myfashion.Domain.TicketAssigneeStatus>();
        ...
        public string getAssignedMembers(string AssigneeUserId)
        {
            try
            {
                Domain.Myfashion.Domain.TicketAssigneeStatus AssigneeMember = new Domain.Myfashion.Domain.TicketAssigneeStatus();
