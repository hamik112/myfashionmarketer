    ...
    public class FbPagePost : System.Web.Services.WebService
    {
        ...
        public string GetPostDetails(string postid)
        {
            try
            {
                ...
                Domain.Myfashion.Domain.FbPagePost lstfbmsgs = objFbPagePostRepository.GetPostDetails(id);
        ...
        public string GetAllPostOfPage(string profileid,string userid)
        {
            try
            {
                ...
                List<Domain.Myfashion.Domain.FbPagePost> lstfbmsgs = objFbPagePostRepository.getAllPost(profileid, UserId);
                return new JavaScriptSerializer().Serialize(lstfbmsgs);
            }
            catch (Exception ex)
            {
        ...
        {
            Domain.Myfashion.Domain.FbPagePost _FbPagePost = (Domain.Myfashion.Domain.FbPagePost)new JavaScriptSerializer().Deserialize((jdata), typeof(Domain.Myfashion.Domain.FbPagePost));
