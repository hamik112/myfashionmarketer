...
namespace Api.Myfashionmarketer.Models
{
    ...
    public class Instagram : System.Web.Services.WebService
    {
        ...
        Domain.Myfashion.Domain.InstagramAccount objInstagramAccount;
        InstagramCommentRepository objInstagramCommentRepository = new InstagramCommentRepository();
        Domain.Myfashion.Domain.InstagramComment objInstagramComment = new Domain.Myfashion.Domain.InstagramComment();
        InstagramFeedRepository objInstagramFeedRepository = new InstagramFeedRepository();
        Domain.Myfashion.Domain.InstagramFeed objInstagramFeed = new Domain.Myfashion.Domain.InstagramFeed();
        ...
        {
            Domain.Myfashion.Domain.InstagramAccount ObjInstagramAccount = (Domain.Myfashion.Domain.InstagramAccount)(new JavaScriptSerializer().Deserialize(ObjInstagram, typeof(Domain.Myfashion.Domain.InstagramAccount)));
            try
            {
