...
namespace Api.Myfashionmarketer.Helper
{
    public static class FbDiscoverySearchHelper
    {
        ...
        public static List<Domain.Myfashion.Domain.DiscoverySearch> ScraperHasTage(string Hash)
        {
            ...
            PagesLink = PagesLink.Skip(1).ToArray();
            List<Domain.Myfashion.Domain.DiscoverySearch> discSearchList = new List<Domain.Myfashion.Domain.DiscoverySearch>();
            foreach (var item_pageSouceSplit in pageSouceSplit)
            {
                Domain.Myfashion.Domain.DiscoverySearch discSearchObj = new Domain.Myfashion.Domain.DiscoverySearch();
                try
                {
                    if (item_pageSouceSplit.Contains("<!DOCTYPE html>"))
                    {
