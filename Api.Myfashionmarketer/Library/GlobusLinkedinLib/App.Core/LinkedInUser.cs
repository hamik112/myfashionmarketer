...
namespace GlobusLinkedinLib.App.Core
{
    public class LinkedInUser
    {
        ...
        /// <returns></returns>
        public List<Domain.Myfashion.Domain.LinkedInUser.User_Updates> GetUserUpdates(oAuthLinkedIn OAuth, string LinkedInId, int Count)
        {
            Domain.Myfashion.Domain.LinkedInUser.User_Updates user_Updates = new Domain.Myfashion.Domain.LinkedInUser.User_Updates();
            List<Domain.Myfashion.Domain.LinkedInUser.User_Updates> UserUpdatesList = new List<Domain.Myfashion.Domain.LinkedInUser.User_Updates>();
        ...
        public List<Domain.Myfashion.Domain.LinkedInUser.User_Updates> GetUserUpdate(oAuthLinkedIn OAuth, string LinkedInId, int Count)
        {
            Domain.Myfashion.Domain.LinkedInUser.User_Updates user_Updates = new Domain.Myfashion.Domain.LinkedInUser.User_Updates();
            List<Domain.Myfashion.Domain.LinkedInUser.User_Updates> UserUpdatesList = new List<Domain.Myfashion.Domain.LinkedInUser.User_Updates>();
            // SocialStream socialStream = new SocialStream();
